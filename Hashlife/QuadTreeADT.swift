...
//        print("why not comming out?") //debug
        let offset = self.offsetToSubnode()
        switch Quadrant.extrapolate(x: x, y: y) {
...
//Disposable:
//            if x < 0 {
//                if y < 0 {return Quadrant.nw} else {
//                    return Quadrant.sw
//                }
//            } else {
//                if y < 0 {return Quadrant.ne} else {
//                    return Quadrant.se
//                }
//            }
//    //This is definitely not the most efficient way...
//    //ACCELERATION MUCH NEEDED FOR DRAWING!!!!
//    func getEnclosingSuperNode(of coordinates: (x: Int, y: Int)...) -> HashedTreeNode {
//        var extrapolated: Quadrant
//        if (coordinates.reduce(false) {
//
////            return (extrapolated = Quadrant.extrapolate(x: $1.x, y: $1.y)) == $0
//        }) {
//
//        }
//        return self
