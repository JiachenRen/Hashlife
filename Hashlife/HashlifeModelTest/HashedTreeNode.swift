...
public class HashedTreeNode: QuadTree, CustomStringConvertible, NodeProtocol{
    ...
    public static var useHashlife = false
    ...
    private func nextGen(_ bitmask: Int) -> HashedTreeNode {
        ...
        return self.initGhost(isAlive: neighborCount == 3 || (neighborCount == 2 && this != 0))
    }
    ...
    public func eval() -> HashedTreeNode {
        if HashedTreeNode.useHashlife {return hashlife()} //using about 100 millis extra per 20000 gen... could be better.
        if pop == 0 {return nw}
    ...
    public func initEmptyTree(lev: Int) -> HashedTreeNode {
        if lev == 0 {return self.initGhost(isAlive: false)}
...
extension HashedTreeNode: Hashable {
    ...
    public static func == (lhs: HashedTreeNode, rhs: HashedTreeNode) -> Bool {
        if lhs.lev != rhs.lev {return false}
        if lhs.lev == 0 {
